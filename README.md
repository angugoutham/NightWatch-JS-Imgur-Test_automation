...
You can copy over our basic configuration saved in nightWatch.conf.js: [`nightWatch.conf.js`](https://github.com/dwyl/learn-nightwatch/blob/master/nightWatch.conf.js)

Or copy the following into a file called nightWatch.conf.js
...
> + [ ] use saucelabs with nightz   watch? http://stackoverflow.com/questions/36137270/how-to-use-saucelabs-with-nightwatch
